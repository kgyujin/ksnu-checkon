          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="p-4 border rounded-lg bg-slate-50">
              ...
              <div className="text-sm text-slate-600 space-y-1">
                ...
                <p><strong>설정됨:</strong> {apiStatus?.apiStatus?.nts?.isConfigured ? '✅' : '❌'}</p>
            ...
            {/* 공정위 */}
            <div className="p-4 border rounded-lg bg-slate-50">
              <h3 className="font-bold text-lg mb-2">⚖️ 공정위 (FTC)</h3>
              <div className="text-sm text-slate-600 space-y-1">
                <p><strong>상태:</strong> {apiStatus?.apiStatus?.ftc?.status || 'N/A'}</p>
                <p><strong>설정됨:</strong> {apiStatus?.apiStatus?.ftc?.isConfigured ? '✅' : '❌'}</p>
              </div>
            </div>

            {/* 특허청 */}
            <div className="p-4 border rounded-lg bg-slate-50">
              <h3 className="font-bold text-lg mb-2">®️ 특허청 (KIPRIS)</h3>
              <div className="text-sm text-slate-600 space-y-1">
